...
const request_data = {
    ...
    data: {
        ...
        'carb_percentage.from': carbPercentageFrom,
        'carb_percentage.to': carbPercentageTo,
        'protein_percentage.from': proteinPercentageFrom,
        'protein_percentage.to': proteinPercentageTo,
        'fat_percentage.from': fatPercentageFrom,
        'fat_percentage.to': fatPercentageTo,
